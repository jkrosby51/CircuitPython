...
class RGB:
    ...
    def Blinky(self, rate=0.5):
        for i in range(5):
            self.myBlueLED.on(65535)
            self.myGreenLED.on(65535)
            self.myRedLED.on(65535)
            time.sleep(rate)
            self.myBlueLED.on(32767)
            self.myGreenLED.on(32767)
            self.myRedLED.on(32767)
            time.sleep(rate)
